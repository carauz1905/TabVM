...
func TestIsNewer(t *testing.T) {
	cases := []struct {
		...
		{"prerelease latest is not newer", "v0.2.0-rc1", "0.1.2", false},
		{"prerelease build metadata latest", "0.2.0-beta.1", "0.1.2", false},
		{"prerelease current gets newer stable", "0.2.1", "0.2.0-rc1", true},
		{"prerelease current, older stable latest", "0.1.0", "0.2.0-rc1", false},
		{"prerelease current, same core stable", "0.2.0", "0.2.0-rc1", false},
